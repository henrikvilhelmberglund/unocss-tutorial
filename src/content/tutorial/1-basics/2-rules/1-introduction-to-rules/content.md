...
Now that we know how to configure UnoCSS we can create our own rules. Rules define utility classes and the resulting CSS. UnoCSS has many built-in rules inside presetWind3 but also allows for easily adding custom rules.
